...
public class inputmadlibs {
    public static void main (String args []){
        ...
        String IP = ("There're a lot of "+word1+" ways to get to school. " +
        ...
        String IIP = ("The "+word1+" bus:Watch out for "+II+" " +
        ...
        String IIIP = ("Bicycle:Check the weather, because it's "+
                word1+" to hold an umbrella while "+II+".");
        //paragraph 2 out
        ...
        String IVP = ("Walk:Don't stop to "+word1+" every "+II+" along the way" +
        ...
        IVP = ("Skate-"+word1+": Cool, but if the "+II+" catches you doing " +
